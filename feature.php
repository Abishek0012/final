    ...
    <div class="row" style="height: 589px;">
      <div class="col-sm">
        <div class="card" style="width: 18rem; height: 37rem;">
          <img src="./images/book-1.jfif" class="card-img-top" style="height: 22rem;"  alt="...">
          <div class="card-body">
            <h5 class="card-title">In Your Own Backyard</h5>
            <p class="card-text">A kids guide to discovering nature in Dubai.</p>
            <a href="review1.php" class="btn btn-primary" style="position: relative; top: 72px;" >Read Review</a>
          </div>
        </div>
      </div> 
      <div class="col-sm">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="review2.php" class="btn btn-primary">Read Review</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm" style="height: 38rem;">
        <div class="card" style="width: 18rem; ">
          ...
          <div class="card-body">
            ...
            <a href="review3.php" class="btn btn-primary" style="position: relative; top: 42px;">Read Review</a>
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="col-sm">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary" style="position: relative; bottom: 20px;">Read Review</a>
          </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary" style="position: relative; top: 26px;">Read Review</a>
          </div>
          </div>
        </div>
      </div>
